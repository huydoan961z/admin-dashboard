    ...
    <form>
      ...
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          <h1 className=" first-text text-base font-semibold leading-7 text-gray-900">Doctor Information</h1>
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            {/* Awards */}
            <div className="col-span-full">
              <label htmlFor="awards" className="block text-sm font-medium leading-6 text-gray-900">Awards</label>
              <div className="mt-2">
                <textarea
                  id="awards"
                  name="awards"
